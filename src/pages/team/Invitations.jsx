...
const Invitations = () => {
  ...
  const invitations = user?.emailAddresses?.flatMap(email => email.invitations || []) || [];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-400 mt-1">Manage your organization invites</p>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="font-medium text-white">
                    {inv?.publicOrganizationData?.name || "Unknown Organization"}
                  </h3>
                  <p className="text-sm text-neutral-400">
                    Invited as <span className="uppercase font-bold text-xs">{inv?.role === 'org:admin' ? 'Admin' : 'Member'}</span>
                  </p>
                </div>
              </div>
